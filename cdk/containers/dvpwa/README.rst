...
If for some reasons you cannot use docker to build the image, you can run the
...
4. Open http://localhost:8000 in the incognito tab.
...
3. Go to http://localhost:8000/students/.
...
1. Open http://localhost:8000/courses/1/review.
...
4. Observe the newly created review. Note that text "Is it bold?" is bold,
   ...
   escaped on output.
5. Open  http://localhost:8000/courses/1/review.
