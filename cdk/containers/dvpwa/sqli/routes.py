...
def setup_routes(app: Application):
    ...
    app.router.add_route(
        "POST", r"/students/{student_id:\d+}/evaluate/{course_id:\d+}", views.evaluate
    )

    app.router.add_route("GET", r"/courses/{course_id:\d+}/review", views.review)
    app.router.add_route("POST", r"/courses/{course_id:\d+}/review", views.review)
